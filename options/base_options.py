...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netD', type=str, default='morph', help='selects model to use for netD [basic | n_layers | pixel | morph]')
        parser.add_argument('--netG', type=str, default='morph', help='selects model to use for netG [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 | morph]')
